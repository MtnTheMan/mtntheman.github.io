...
excerpt: "The second day of the Northern Hardwood Megatrip considers how forest patch size and agricultural context shape deer browse pressure and hardwood regeneration."
---
...
<figure class="nhr-figure full-width nhr-photo protected-image" oncontextmenu="return false;">
  <img
    src="{{ site.baseurl }}/assets/images/NHR%20Blog/blog_day_two_images/day-two-healthy-understory-stream.jpeg"
    alt="Healthy dense forest understory with a small stream beneath a contiguous hardwood canopy"
    loading="lazy"
    draggable="false"
  >
  <figcaption>A healthy, dense understory beneath a larger contiguous hardwood canopy.</figcaption>
</figure>
...
<figure class="nhr-figure full-width nhr-photo protected-image" oncontextmenu="return false;">
  <img
    src="{{ site.baseurl }}/assets/images/NHR%20Blog/blog_day_two_images/day-two-contiguous-maple-understory.jpeg"
    alt="Sugar maple regeneration and a trail beneath a contiguous hardwood canopy"
    loading="lazy"
    draggable="false"
  >
  <figcaption>Filtered light and maple regeneration along a trail in the larger forest block.</figcaption>
</figure>
...
<!-- Future image slot: add a ground-level or aerial image at assets/images/NHR%20Blog/blog_day_two_images/day-two-woodlot-field-edge.jpeg showing the abrupt edge where a small isolated forest woodlot meets an open agricultural field. Once the image is uploaded, replace this comment with a full nhr-photo figure block. -->
