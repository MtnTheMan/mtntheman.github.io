...
<figure class="nhr-figure full-width nhr-photo protected-image" oncontextmenu="return false;">
  <img
    src="{{ site.baseurl }}/assets/images/northern-hardwoods-megatrip/day-two-healthy-understory-stream.jpeg"
...
<!-- Future image slot: add a ground-level or aerial image at assets/images/northern-hardwoods-megatrip/day-two-woodlot-field-edge.jpeg showing the abrupt edge where a small isolated forest woodlot meets an open agricultural field. Once the image is uploaded, replace this comment with a full nhr-photo figure block. -->
