...
<figure class="nhr-figure full-width nhr-photo protected-image" oncontextmenu="return false;">
  <img
    ...
    draggable="false"
  >
  <figcaption>A landowner-facing forestry book like <em>Managing Your Woods</em> is one visible piece of a much larger knowledge system that also includes consultants, extension, neighbors, online videos, and personal trial and error.</figcaption>
</figure>
...
<!--
Image placeholder: Insert a second photo here if you want a more active working-woods image.

<figure class="nhr-figure full-width nhr-photo protected-image" oncontextmenu="return false;">
  <img
    src="{{ site.baseurl }}/assets/images/northern-hardwoods-megatrip/nhr-log-8-working-woods.jpeg"
    alt="A consultant, logger, or landowner working in the woods"
    loading="lazy"
    draggable="false"
  >
  <figcaption>A working-woods image could reinforce the section on making forestry knowledge visible, engaging, and responsible in online spaces.</figcaption>
</figure>
-->
