...
<figure class="nhr-figure full-width nhr-photo protected-image" oncontextmenu="return false;">
  <img
    src="{{ site.baseurl }}/assets/images/northern-hardwoods-megatrip/day-one-blue-water-bridge.jpeg"
    alt="Blue Water Bridge crossing between Port Huron, Michigan and Sarnia, Ontario"
    loading="lazy"
    draggable="false"
  >
...
<figure class="nhr-figure full-width nhr-photo protected-image" oncontextmenu="return false;">
  <img
    src="{{ site.baseurl }}/assets/images/northern-hardwoods-megatrip/day-one-ontario-photo-on-a-tree.jpeg"
    alt="A dandelion growing aloft on a sugar maple in southwestern Ontario"
    loading="lazy"
    draggable="false"
  >
